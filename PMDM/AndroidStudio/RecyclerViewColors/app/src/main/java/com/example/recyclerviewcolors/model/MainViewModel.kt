...
class MainViewModel : ViewModel() {
    private val _data = MutableLiveData<List<MyColor>>(emptyList())
    val data: LiveData<List<MyColor>> get() = _data
    ...
    fun add(position: Int, name: String, code: String){
        viewModelScope.launch {
            _add.value = myState.add(position, name, code)
        }
    }
